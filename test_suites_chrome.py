...
from ActionPage.ActionPage_test import ActionPage, AddNewContactPage1, AddNewContactPage, AddNewContactPage2, \
    AddNewContactPage3, AddNewContactPage4, AddNewContactPage5, AddNewContactPage6, AddNewContactPage7, \
    AddNewContactPage8, AddNewContactPage9, LogoutPage
from config.config import ConfigAddNewContact, ConfigAddNewContact1, Config, ConfigAddNewContact2, ConfigAddNewContact3, \
    ConfigAddNewContact4, ConfigAddNewContact5, ConfigAddNewContact6, ConfigAddNewContact7, ConfigAddNewContact8, \
    ConfigAddNewContact9
